...
define('TED_PORT', 80);					# The port number of your TED gateway device
...
define('TED_API', 'minutehistory');		# The API request to use ++
define('TED_MTU', 0);					# The MTU number to retrieve data +++
define('TED_TYPE', 'power');			# The field you wish to calculate ++++
